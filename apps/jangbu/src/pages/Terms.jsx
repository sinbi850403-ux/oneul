    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 bg-white mt-6 rounded-2xl shadow-sm">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-800 mb-3">제2조 (서비스 소개)</h2>
            <p className="text-sm">오늘장부는 1인 소상공인을 위한 일매출 기록 및 세금 안내 서비스입니다. 서비스는 Google AdSense 광고 수익으로 운영되며 기본 기능은 무료로 제공됩니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-gray-800 mb-3">제3조 (회원가입 및 이용)</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-800 mb-3">제4조 (서비스 이용 제한)</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-800 mb-3">제5조 (데이터 및 책임)</h2>
            <ul className="list-disc pl-6 space-y-1 text-sm">
