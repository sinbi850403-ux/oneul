    ...
    <div className="bg-stone-50 min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 bg-white mt-6 rounded-2xl shadow-card">
        ...
        <div className="space-y-8 text-stone-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">1. 수집하는 개인정보 항목</h2>
            ...
            <p className="mt-2 text-sm text-stone-500">이름, 전화번호, 주민등록번호 등 기타 개인정보는 수집하지 않습니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">2. 개인정보 수집 및 이용 목적</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">3. 개인정보 보유 및 이용 기간</h2>
            <p className="text-sm">회원 탈퇴 시 즉시 모든 개인정보 및 매출 데이터를 삭제합니다. 단, 관련 법령에 의해 보존이 필요한 경우 해당 기간 동안 보관합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">4. 개인정보 제3자 제공</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">5. 광고 서비스 안내</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">6. 쿠키(Cookie) 사용</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">7. 이용자의 권리</h2>
            <ul className="list-disc pl-6 space-y-1 text-sm">
          ...
          <section>
            <h2 className="text-lg font-bold text-stone-800 mb-3">8. 개인정보 보호 책임자</h2>
